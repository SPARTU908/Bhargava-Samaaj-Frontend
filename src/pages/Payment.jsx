...
//                 ✅ Your payment details have already been submitted. Please
...
const Payment = () => {
  ...
  const validate = () => {
    ...
    if (!paymentdata.transaction) {
      ...
      if (!paymentdata.upload) {
      newErrors.upload = "Please upload the form";
    }
        ...
        {!isFormSubmitted ? (
          ...
          <div className={styles.step3}>
            ...
            <div className={styles.inputBox}>
                ...
                <FileUpload paymentId={paymentId} url={photourl} setUrl={setPhotoUrl}/>
