...
const Society = () => {
  ...
  return (
    <>
      ...
      {/* Hamare Purvaz */}
      <Container id="ancestors" className="my-5">
        <h2 className="text-center mb-4">हमारे पूर्वज</h2>
        <p>
          ...
          {/* 👉 आपका टेक्स्ट वैसे ही रखा है, पूरा नहीं दोहराया */}
        </p>
        <div className="text-center">
          <Button
            style={{ backgroundColor: "#ea8d0c", border: "none" }}
      ...
      {/* Hamare Mahapurush */}
      <Container id="greatMen" className="my-5">
        <h2 className="text-center mb-4">हमारे-महापुरुष</h2>
        <Row className="text-center g-4">
          <Col md={3} sm={6}>
            <Image src={img1} fluid rounded />
            <div>हमारे आदि पुरुष महिर्ष भृगु</div>
          </Col>
          <Col md={3} sm={6}>
            <Image src={img2} fluid rounded />
            <div>हमारे पूज्य बाबा चरणदास जी महाराज</div>
          </Col>
          <Col md={3} sm={6}>
            <Image src={img4} fluid rounded />
            <div>अन्तिम हिन्दू सम्राट हेमचन्द्र विक्रमादित्य</div>
          </Col>
          <Col md={3} sm={6}>
            <Image src={img3} fluid rounded />
            <div>ऋषिवर च्यवन और सुकन्या</div>
          </Col>
        </Row>
      ...
      {/* Vanshavali */}
      <Container id="genealogy" className="my-5">
        <h2 className="text-center mb-4">वंशावली</h2>
        <Row className="mb-3">
          <Col md={6}>
          ...
          <Col md={6}>
            ...
            <p className="mt-2">
              महर्षि च्यवन मन्दिर, कोसी धाम पर आगे वाले हिस्से की दो गुमटी...
            </p>
          </Col>
        </Row>
        <div className="text-center">
      ...
      {/* Hamare Sanskar */}
      <Container id="values" className="my-5">
        <h2 className="text-center mb-4">हमारे-संस्कार</h2>
        <p>
      ...
      <Container id="festivals" className="my-5">
        <h2 className="text-center mb-4">हमारे-त्यौहार</h2>
        <p>
