...
const Registration = () => {
  ...
  //   try {
  //     const res = await registerUser(formDataToSend); // axios POST with FormData
  ...
  return (
    <>
      ...
      >
        ...
        >
          Registration for 133<sup>th</sup> Annual Conference at Ujjain
        </h2>
            ...
            >
              <Card.Body>
                ...
                >
                  ...
                  <p>
                    The screenshot could be shared with me or Dr. Dheeraj
                    Bhargava for the purpose of reconciliation of the payment
                    made by you against the form filled.
                  </p>
