      ...
      <div className={styles.container}>
        ...
        <div className={styles.row1}>
          ...
          <div className={styles.inputBox}>
            ...
            {errors.gender && <p className={styles.error1}>{errors.gender}</p>}
          </div>
        </div>
        ...
        <div className={styles.row1}>
          ...
          <div className={styles.inputBox}>
            ...
            <input
              ...
              onChange={handleChange}
            />
            {errors.weight && <p className={styles.error1}>{errors.weight}</p>}
          </div>
        </div>
        ...
        <div className={styles.row1}>
          <div className={styles.inputBox}>
            ...
            {errors.manglik && <p className={styles.error}>{errors.manglik}</p>}
          </div>
        ...
        <div className={styles.row1}>
          <div className={styles.inputBox}>
            ...
            <input
              ...
              onChange={handleChange}
            />
            {errors.kuldevi && <p className={styles.error}>{errors.kuldevi}</p>}
          </div>
        ...
        <div className={styles.row1}>
          ...
          <div className={styles.inputBox}>
            ...
            <input
              ...
              onChange={handleChange}
            />
            {errors.income && <p className={styles.error1}>{errors.income}</p>}
          </div>
        </div>
