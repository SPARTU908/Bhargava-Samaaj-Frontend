...
import styles from "./SpousePhotoUpload.module.css"

const SpousePhotoUpload = ({url,setUrl,disabled}) => {
  ...
  return (
    <div>
      <form onSubmit={handleSubmit} encType="multipart/form-data" className={styles.input}>
        <input type="file" name="file" onChange={handleChange} ref={fileInputRef} disabled={disabled} accept="image/png, image/jpeg, image/jpg, "/>
...
export default SpousePhotoUpload;
